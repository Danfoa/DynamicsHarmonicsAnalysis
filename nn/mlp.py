"""Adapted from https://github.com/Danfoa/MorphoSymm/blob/devel/morpho_symm/nn/EMLP.py."""
import logging
...
class MLP(torch.nn.Module):
    ...
    def __init__(self,
        ...
        Args:
        ----
            dim_input: Dimension of the input space.
            dim_output: Dimension of the output space.
