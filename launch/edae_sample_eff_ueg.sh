...
python train_observables.py --multirun device=1 system.group=C5 system.train_ratio=0.5  ${hydra_params} ${shared_params} &
python train_observables.py --multirun device=2 system.group=C5 system.train_ratio=0.75 ${hydra_params} ${shared_params} &
...
python train_observables.py --multirun device=5 system.group=C10 system.train_ratio=0.5  ${hydra_params} ${shared_params} &
python train_observables.py --multirun device=6 system.group=C10 system.train_ratio=0.75 ${hydra_params} ${shared_params} &
